                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="name" value="{{ $homeslide->title }}" type="text" placeholder="Artisanal kale" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                        ...
                        <img class="rounded avatar-lg" id="showImage" src="{{ ( !empty( $homeslide->profile_image)) ? url('upload/home_slide/' . $homeslide->home_slide) : url('upload/no_image.png') }}" alt="Card image cap">
                        </div>
